               ...
               steps {      
                     sh '''
                        ...
                        if [ $? -eq 1 ]; then
                           ...
                           helm install $9 nginx-app-chart --set image.repository=$6 --set image.tag=$7 --set replicaCount=$8 --set resources.limits.cpu="$10" --set resources.limits.memory="$11" --set resources.requests.cpu="$12" --set resources.requests.memory="$13" -n $1
                        fi
                        }
